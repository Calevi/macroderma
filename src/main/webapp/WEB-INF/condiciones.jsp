...
<body>
   ...
   <section class="hero">
    ...
    <section class="terms">
        <!-- Contenido de la secci�n de condiciones de uso -->
        ...
        <p>Todo el contenido de este sitio web, incluyendo texto, im�genes, logotipos y marcas registradas, est� protegido por derechos de propiedad intelectual y no puedes utilizarlo sin nuestro permiso.</p>

        <h3>3. Privacidad</h3>
        <p>Nuestra pol�tica de privacidad describe c�mo recopilamos, utilizamos y protegemos tu informaci�n personal. Al utilizar este sitio, aceptas nuestras pr�cticas de privacidad.</p>

        <h3>4. Cambios en las Condiciones</h3>
        <p>Nos reservamos el derecho de modificar estas condiciones en cualquier momento. Es tu responsabilidad revisarlas peri�dicamente para estar al tanto de cualquier cambio.</p>
