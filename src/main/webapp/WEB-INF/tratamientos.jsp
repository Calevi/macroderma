...
<body>
    ...
    <section class="products">
        ...
        <div class="product">
            ...
            <h3>Pink Glow</h3>
            <p>Mesoheal Pink Glow, del laboratorio KORU Pharma, contiene 55 ingredientes activos que trabajan en sinergia para brindar brillo, suavidad y salud a la piel. Además, mejora la tensión de la piel y los niveles de hidratación, creando un efecto de resplandor. Cada ingrediente en Pink Glow tiene su propia función y está respaldado por investigaciones científicas, pero la magia ocurre cuando estos ingredientes trabajan juntos..</p>
            <a href="https://wa.me/+56933876798" target="_blank" class="button-link">Contratar</a>
        </div>
